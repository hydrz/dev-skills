...
_配置规格约定、issue 追踪器与领域文档。多数人从 `/setup-dev-skills` 开始。_
...
_保持代码库健康、定位疑难缺陷、化解合并冲突并守住质量门禁。_
