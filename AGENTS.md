...
使用 GitHub Issues 管理 issue 和规格。见 `docs/agents/issue-tracker.md`。

### 分诊标签

使用五个标准分诊角色与同名标签。见 `docs/agents/triage-labels.md`。

### 领域文档

单上下文布局，根目录 `CONTEXT.md` 配合 `docs/adr/`。见 `docs/agents/domain.md`。
